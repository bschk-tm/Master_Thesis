...
class CantileverPINN_Regularization_HPT(tf.keras.Model):
    ...
    def __init__(self,E = 1.0, I = 1.0, p = 1.0, L=1.0):
        ...
        super(CantileverPINN_Regularization_HPT, self).__init__()
        self.E = E
        self.I = I
        self.p = p
        self.Length = L
    ...
    def build(self,input_shape):
        ...
        super(CantileverPINN_Regularization_HPT, self).build([input_shape])
